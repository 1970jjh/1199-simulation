                ...
                <div className="p-8 space-y-8">
                    ...
                    <div className="flex flex-col md:flex-row gap-6 mt-8 pt-8 border-t border-gray-100 dark:border-slate-800">
                         ...
                         <div className="flex-[2]">
                            ...
                            <p className="text-gray-700 dark:text-gray-300 italic whitespace-pre-wrap mb-6">"{analysis.conclusion}"</p>

                            {/* 교육적 의미 + 역량 테이블 */}
                            <h4 className="font-bold text-cyan-500 dark:text-cyan-400 mb-2 uppercase tracking-wide text-sm">Educational Significance (교육적 의미)</h4>
                    ...
                    <div className="mt-8 pt-8 border-t border-gray-100 dark:border-slate-800">
                      <h4 className="font-bold text-amber-500 dark:text-amber-400 mb-2 uppercase tracking-wide text-sm flex items-center gap-2">
                      ...
                      <div className="grid gap-3">
                        {[
                          '우리 팀의 의사결정은 데이터 기반이었나, 감(感) 기반이었나요? 우리팀은 어떠한 과정을 통해 의사결정하였나요?',
                          '시장 환경(게임의 룰)이 바뀌었을 때, 우리 팀의 전략도 바뀌었나요? 각 시장(초기형성, 완전경쟁, 독점적 경쟁)마다 우리 팀의 전략은 무엇이었나요?',
                          '실제 업무에서 이러한 \'전환/변화 지점\'을 놓친 경험이 있나요?',
                          '팀 의사결정시, 팀 내 반대 의견이 나왔을 때 우리 팀은 어떻게 합의를 이루었나요?',
                          '팀 의사결정시, 상대팀의 행동을 얼마나, 어떻게 고려하여 결정하였나요? (경쟁사 분석)',
                        ].map((question, idx) => (
